% this implements tracking multiple objects using the Kanade-Lucas-Tomasi (KLT) algorithm.
...
classdef MultiObjectTrackerKLT < handle
    properties
        ...
        % Bboxes Mx4 matrix of [x y w h] object bounding boxes
        Bboxes = [];
        
        % BoxIds Mx1 array containing ids associated with each bounding box
        BoxIds = [];
        
        % Points Mx2 matrix containing tracked points from all objects
        Points = [];
        
        % PointIds M-by-1 array containing object id associated with each  point. This array keeps track of which point belongs to which object.
        PointIds = [];
    ...
    methods
        ...
        % object, or whether it is a brand new object.
            for i = 1:size(bboxes, 1)
                % Determine if the detection belongs to one of the existing objects.
